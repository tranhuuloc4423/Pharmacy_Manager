namespace Quanlyhieuthuoc.BanThuoc
{
    partial class ucBanThuoc
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgThuoc.Columns.AddRange(new DataGridViewColumn[] { MaThuoc, TenThuoc, TenLoaiThuoc, DonViTinh, GiaBan, SoLuongTonKho });
            ...
            // SoLuongTonKho
            // 
            SoLuongTonKho.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            SoLuongTonKho.DataPropertyName = "SoLuong";
            SoLuongTonKho.HeaderText = "Số Lượng";
